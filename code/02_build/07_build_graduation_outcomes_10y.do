/**********************************************************************
* 08_build_graduation_outcomes_10y.do
*
* Construye outcomes de titulación a 10 años usando bases SIES Titulados
...
*
* Nota:
*   - Con titulados hasta 2024, solo las cohortes 2007-2014
*     tienen ventana completa de 10 años.
**********************************************************************/
...
* Con titulados hasta 2024, cohortes 2007-2014 tienen 10 años completos
...
************************************************************
* 5. Outcomes generales: graduates_he_10y y graduates_uni_10y
************************************************************
...
keep if grad_year <= ao_proceso + 10
...
collapse ///
    (max) graduates_he_10y  = grad_he_aux ///
    (max) graduates_uni_10y = grad_uni_aux, ///
...
************************************************************
* 6. Outcome target: graduates_target_10y
************************************************************
...
collapse (max) graduates_target_10y = grad_target_aux, by(sample_id)
...
replace graduates_he_10y = 0 if missing(graduates_he_10y)
replace graduates_uni_10y = 0 if missing(graduates_uni_10y)

drop _merge

merge 1:1 sample_id using `grad_target'

replace graduates_target_10y = 0 if missing(graduates_target_10y)

drop _merge sample_id

label var graduates_he_10y     "Graduated from higher education within 10 years"
label var graduates_uni_10y    "Graduated from university within 10 years"
label var graduates_target_10y "Graduated from target program within 10 years"

compress

save "$processed/analysis_sample_with_fields_graduation_10y.dta", replace
...
di as text "=================================================="
di as result "Graduation outcomes built: 10-year window"
di as text "=================================================="

count

tab graduates_he_10y
tab graduates_uni_10y
tab graduates_target_10y

tab field graduates_he_10y, row
tab field graduates_uni_10y, row
tab field graduates_target_10y, row

di as result "Output guardado en:"
di as result "$processed/analysis_sample_with_fields_graduation_10y.dta" 